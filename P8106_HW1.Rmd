...
* The MSE of fitting linear model is `r mse(sol_test$solubility,linear_pred)`.

* The MSE of fitting ridge model is `r mse(sol_test$solubility,pred.ridge)`. MSE using Caret is `r mse(sol_test$solubility,pred.ridge)`.

* The MSE of fitting lasso model is `r mse(sol_test$solubility,lasso_pred[,1])`. MSE using Caret is `r mse(sol_test$solubility,pred.lasso)`.

* The MSE of fitting PCR is `r mse(sol_test$solubility,pcr_pred)`. MSE using Caret is `r mse(sol_test$solubility,pred.pcr)`.
