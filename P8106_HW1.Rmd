...
* The MSE of fitting linear model to test dataset is `r mse(sol_test$solubility,linear_pred)`.

* The MSE of fitting ridge model to test dataset is `r mse(sol_test$solubility,pred.ridge)`. MSE using Caret is `r mse(sol_test$solubility,pred.ridge)`.
